...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="container mx-auto p-4">
        <h2 class="text-3xl font-bold mb-6 text-center text-gray-800 uppercase">Crear Nuevo Usuario</h2>
        <form action="{{ route('users.store') }}" method="POST" class="bg-white p-6 shadow-md rounded-lg">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="surname" class="w-full p-2 border border-gray-300 rounded" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="birthday" class="w-full p-2 border border-gray-300 rounded" required>
            </div>
            <div class="mb-4">
