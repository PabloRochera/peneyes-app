<header class="bg-blue-700 text-white py-4 shadow-md">
    <div class="container mx-auto max-w-screen-lg px-4 flex justify-between items-center">
        <h1 href="{{ route('users.index') }}" class="text-2xl font-bold">INICIO</h1>
        <nav class="flex space-x-4 items-center">
            <a href="{{ route('users.index') }}" class="hover:underline">USUARIOS</a>
            <a href="{{ route('crews.index') }}" class="hover:underline">PEÑAS</a>
            <a href="{{ route('draws.index') }}" class="hover:underline">SORTEO</a>
            <a href="{{ route('draws.index') }}" class="hover:underline">PAGOS</a>
